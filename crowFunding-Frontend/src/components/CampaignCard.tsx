...
function CampaignCard(props: CampaignCardProps) {
  ...
  const getStatusBadge = () => {
    ...
    return badges[props.campaign.status];
  };

  // Progress bar color
  const getProgressColor = () => {
    if (props.campaign.status === "Successful" || displayProgress >= 100)
      return "bg-green-500";
    if (props.campaign.status === "Failed") return "bg-red-500";
    return "bg-blue-500";
  };
    ...
    <li className="group">
      ...
      >
        ...
        <div className="mb-4 pb-4 border-b border-slate-700">
          ...
          <p className="text-sm font-mono text-slate-300">
            {shortenAddress(props.campaign.creator)}
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm font-semibold text-purple-400">
              {props.campaign.rewardRate} tokens/ETH
            </p>
          </div>
